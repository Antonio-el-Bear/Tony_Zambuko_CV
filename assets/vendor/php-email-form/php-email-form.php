...
class PHP_Email_Form {
  ...
  public function __construct() {
    $this->mailer = "forms@" . @preg_replace('/^www\./','', $_SERVER['https://antoniozambuko.com/']);
  ...
  public function send() {
    ...
    try {
      ...
      if( is_array( $this->smtp) ) {
        $mail->isSMTP();
        $mail->Host = $this->smtp['https://antoniozambuko.com/'];
        $mail->SMTPAuth = true;
        $mail->Username = $this->smtp['_mainaccount@antoniozambuko.com'];
        $mail->Password = $this->smtp['aRukyCp!eBQT9$'];
        $mail->Port = $this->smtp['465'];
